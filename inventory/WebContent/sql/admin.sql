...
CREATE TABLE `man_manufacturer` (
  ...
  `DESCRIPTION` longtext COMMENT '品牌商公司介绍',
  `CREATED_BY` varchar(20) DEFAULT NULL COMMENT '创建人',
  `CREATION_DATE` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `LAST_UPDATE_BY` varchar(20) DEFAULT NULL COMMENT '更新人',
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT '更新时间',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '223ce7b851123353479d85757fbbf4e320d1e251', '系统管理员', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2017-10-19 14:21:05', '0:0:0:0:0:0:0:1', 'a', '系统管理员', 'default', '123@123.com', '001', '18788888888', '1');
