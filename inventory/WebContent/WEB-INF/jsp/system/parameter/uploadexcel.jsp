...
<body>
	<form action="parameter/readExcel.do?userName=${userName }" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/parameter/downExcel.ajax'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
