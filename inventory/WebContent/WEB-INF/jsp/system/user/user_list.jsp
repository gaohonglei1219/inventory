	...
	<div class="row-fluid">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover dataTable" aria-describedby="table_report_info">
			<thead>
				<tr role="row">
					...
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 60px;">序号</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 60px;" >编号</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 70px;" >用户名</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 70px;" >用户名</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 70px;" >角色</th>
					<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 120px;" >邮箱</th>
					<th class="hidden-phone sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 150px;" >最近登录</th>
					<th class="hidden-phone sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 120px;" >
						<i class="icon-time hidden-phone"></i> 上次登录IP</th>
					<th class="hidden-480" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1" colspan="1" style="width: 70px;" >操作</th>
				</tr>
			</thead>
			<tbody>
				<!-- 开始循环 -->	
							...
							<tr>
								...
								<td style="width: 60px;">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<c:if test="${QX.edit == 1 }">
											<c:if test="${user.USERNAME != 'admin'}"><a class='btn btn-mini btn-success' title="编辑" onclick="editUser('${user.USER_ID }');"><i class='icon-edit'></i></a></c:if>
											<c:if test="${user.USERNAME == 'admin'}"><a class='btn btn-mini btn-success' title="您不能编辑"><i class='icon-edit'></i></a></c:if>
										</c:if>
										<c:choose>
		...
		<table style="width:100%; margin-left:30px;">
			<tr>
				<td style="vertical-align:top;">
					<c:if test="${QX.add == 1 }">
					<a class="btn btn-small btn-yellow" onclick="add();">新增</a>
					</c:if>
					<%--<c:if test="${QX.FX_QX == 1 }">--%>
				...
				<td style="vertical-align:top;"><div class="pagination" style="float: right;padding-top: 0px;margin-top: 0px; margin-right:30%">${page.pageStr}</div></td> 
			</tr>
		</table>
		</div>
	</div>
